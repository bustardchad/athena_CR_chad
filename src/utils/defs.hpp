...
// problem generator
#define PROBLEM_GENERATOR "coolpulse_Chad"
...
#define COMPILED_WITH_OPTIONS " -I/opt/apps/intel18/impi18_0/phdf5/1.10.4/x86_64/include -O3 -std=c++11  -L/opt/apps/intel18/impi18_0/phdf5/1.10.4/x86_64/lib  -lhdf5" // NOLINT

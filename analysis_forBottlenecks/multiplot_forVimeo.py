...
times = range(60,100,1)

for i in times:
 fn = "noIonAlfven_noDamping/noClumpsNearBoundary/L5/alpha1_5/"
 base = 'cr.out1.'
 ds = yt.load(fn+base+str(i).zfill(5)+'.athdf')

 fn2 = "noIonAlfven_noDamping/noClumpsNearBoundary/L5/alpha1_5/"
 base = 'cr.out2.'
 ds2 = yt.load(fn2+base+str(i).zfill(5)+'.athdf')

 fn3 = "ionAlfven_Damping/noClumpsNearBoundary/L5_alpha1_5/"
 base = 'cr.out1.'
 ds3 = yt.load(fn3+base+str(i).zfill(5)+'.athdf')

 fn4 = "ionAlfven_Damping/noClumpsNearBoundary/L5_alpha1_5/"
 base = 'cr.out2.'
 ...
 for j in range(4):
   ...
   if (j==3):
     ...
     fig.suptitle("t = %3.0f Myr" % time,fontsize=20)
 ...
 plt.savefig('multiplot_forVimeo_'+str(i).zfill(5)+'.png')
# plt.savefig('multiplot_damping_nodamping.pdf')

...
# can render them
#slc_frb = FixedResolutionBuffer(ds.slice(0,1.0),(0.0,0.0,1.0,2.0),(512,512))
ds.periodicity=(True,True,True)
ds2.periodicity=(True,True,True)
sl = ds.slice("z",0.0)
sl2 = ds2.slice("z",0.0)
#sl2 = ds2.r[:,:,0.0]
slc_frb = FixedResolutionBuffer(sl,(0.0,-1.0,1.0,1.0),(256,512))
proj_frb = FixedResolutionBuffer(sl2,(0.0,-1.0,1.0,1.0),(256,512))

plt.imshow(np.array(slc_frb['density']))
plt.savefig('my_perfect_figure.png')

#proj_frb2 = FixedResolutionBuffer(ds2.slice(0,"collisionless"),(0.0,0.0,1.0,2.0),(512,512))

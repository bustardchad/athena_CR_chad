...
for i in times:
 fn = "noIonAlfven_noDamping/noClumpsNearBoundary/L5/alpha1_5_lowerB/"
 base = 'cr.out1.'
 ds = yt.load(fn+base+str(i).zfill(5)+'.athdf')

 fn2 = "noIonAlfven_noDamping/noClumpsNearBoundary/L5/alpha1_5_lowerB/"
 base = 'cr.out2.'
 ds2 = yt.load(fn2+base+str(i).zfill(5)+'.athdf')

 fn3 = "ionAlfven_Damping/noClumpsNearBoundary/L5_alpha1_5/lowerB/"
 base = 'cr.out1.'
 ds3 = yt.load(fn3+base+str(i).zfill(5)+'.athdf')

 fn4 = "ionAlfven_Damping/noClumpsNearBoundary/L5_alpha1_5/lowerB/"
 base = 'cr.out2.'
 ...
 plt.savefig('multiplot_withTemperature_lowerB_forVimeo_'+str(i).zfill(5)+'.png')

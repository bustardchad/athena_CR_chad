...
print(profile_ecr.x)
va_L5_alpha15 = profile_ecr["gas", "ecr"]
...
print(profile_ecr.x)
vaion_L5_alpha15 = profile_ecr["gas", "ecr"]
print(profile_ecr["gas", "ecr"]) 
cray = np.array(profile_ecr["gas", "ecr"])
profile_vol = yt.create_profile(ad, "tmp", ["cell_volume"],weight_field=None, fractional=True, accumulation=False,extrema={'cell_volume': (1e-3, 1e0),
                                      'tmp': (1e3, 5e5)},n_bins=(32))
...
print(profile_ecr.x)
va_L2_alpha15 = profile_ecr["gas", "ecr"]
print(profile_ecr["gas", "ecr"]) 
cray = np.array(profile_ecr["gas", "ecr"])
profile_vol = yt.create_profile(ad, "tmp", ["cell_volume"],weight_field=None, fractional=True, accumulation=False,extrema={'cell_volume': (1e-3, 1e0),
                                      'tmp': (1e3, 5e5)},n_bins=(32))
...
print(profile_ecr.x)
va_L5_alpha15_lowerB = profile_ecr["gas", "ecr"]
print(profile_ecr["gas", "ecr"]) 
cray = np.array(profile_ecr["gas", "ecr"])
profile_vol = yt.create_profile(ad, "tmp", ["cell_volume"],weight_field=None, fractional=True, accumulation=False,extrema={'cell_volume': (1e-3, 1e0),
                                      'tmp': (1e3, 5e5)},n_bins=(32))
...
print(profile_ecr.x)
vaion_L5_alpha15_lowerB = profile_ecr["gas", "ecr"]
print(profile_ecr["gas", "ecr"]) 
cray = np.array(profile_ecr["gas", "ecr"])
profile_vol = yt.create_profile(ad, "tmp", ["cell_volume"],weight_field=None, fractional=True, accumulation=False,extrema={'cell_volume': (1e-3, 1e0),
                                      'tmp': (1e3, 5e5)},n_bins=(32))
...
print(profile_ecr.x)
va_L2_alpha15_lowerB = profile_ecr["gas", "ecr"]
print(profile_ecr["gas", "ecr"]) 
cray = np.array(profile_ecr["gas", "ecr"])
profile_vol = yt.create_profile(ad, "tmp", ["cell_volume"],weight_field=None, fractional=True, accumulation=False,extrema={'cell_volume': (1e-3, 1e0),
                                      'tmp': (1e3, 5e5)},n_bins=(32))
...
plt.tight_layout()
plt.savefig("Ecr_concentration.pdf")
plt.close()
